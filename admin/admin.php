...
<body>
    ...
    <div class="main-container">
        ...
        <div class="spotify-playlists">
            <h2>Admin</h2>
            <a href="admin_edit.php"><button style="padding: 10px; background: white; color: black; font-weight: 900; font-size: 15px; margin-bottom: 10px;">Add New Admin</button></a>
            <div class="list">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {  ?>
                            <tr>
                                ...
                                <td>
                                    <a href="admin_edit.php?id=<?php echo $row['id']; ?>" style="background: #222222; color: white; border: 1px solid white; padding: 10px;"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;
                                    <?php if ($_SESSION['user_id'] != $row['id']) { ?>
                                        <a href="admin_delete.php?id=<?php echo $row['id']; ?>" style="background: #222222; color: red; border: 1px solid red; padding: 10px;"><i class="fa fa-trash"></i></a>
                                    <?php } ?>
                                </td>
                            </tr>
